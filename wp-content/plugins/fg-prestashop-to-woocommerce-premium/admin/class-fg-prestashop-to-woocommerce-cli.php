 ...
 * 
 * @link       https://www.fredericgilles.net/prestashop-to-woocommerce/
 * @since      4.15.0
 *
...
if ( !class_exists('FG_PrestaShop_to_WooCommerce_WPCLI', false) ) {

	/**
	 * Import PrestaShop to WooCommerce using WP CLI
	 *
	 * @package    FG_PrestaShop_to_WooCommerce_Premium
	 * @subpackage FG_PrestaShop_to_WooCommerce_Premium/admin
	 * @author     Frédéric GILLES
	 */
	class FG_PrestaShop_to_WooCommerce_WPCLI {
